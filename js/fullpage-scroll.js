...
(function () {
	...
	var fullScroll = function (params) {
		 ...
		 * @type {Array}
		 */
		var articles = main.getElementsByTagName('section > article');
	 ...
	 */
	fullScroll.prototype.buildarticles = function () {
		var articles = this.defaults.articles;
